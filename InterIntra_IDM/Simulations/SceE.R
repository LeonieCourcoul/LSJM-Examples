...
alpha_sigma_12 <- 0.2
alpha_kappa_12 <- -0.18
shape_01 <- 1 #Exponential equivalent
shape_02 <- 1 #Exponential equivalent
shape_12 <- 1 #Exponential equivalent
...
for(rep in 1:nb.simu){
  ...
  if(lsjm.simu.IC$result_step1$istop !=1){
    ...
    if(lsjm.simu.IC$result_step2$istop !=1){
      ...
      estimateur.step2.IC[rep,] <- z$table.res[c(1:19,26:31),1]
      se.estimateur.step2.IC[rep,] <- z$table.res[c(1:19,26:31),2]
    }
  }
...
true_param <-c(alpha0_01, alpha_y_01, alpha_slope_01, alpha_sigma_01, alpha_kappa_01,
               alpha0_02, alpha_y_02, alpha_slope_02, alpha_sigma_02, alpha_kappa_02,
               alpha0_12, alpha_y_12, alpha_slope_12, alpha_sigma_12, alpha_kappa_12,
...
colnames(CR2.IC) <- c("alpha0_01", "alpha_y_01", "alpha_slope_01" , "alpha_01_sigma", "alpha_01_kappa",
...
CR_pour2.IC <- c((table(CR2.IC$alpha0_01)/nb.simu.cv)[2],
...
colnames(CR2.naive) <- c("alpha0_01", "alpha_y_01", "alpha_slope_01" , "alpha_01_sigma", "alpha_01_kappa",
                         "alpha0_02", "alpha_y_02", "alpha_slope_02" , "alpha_02_sigma", "alpha_02_kappa",
                         "alpha0_12", "alpha_y_12", "alpha_slope_12" , "alpha_12_sigma", "alpha_12_kappa",
                         "beta0", "beta1", "mu.sigma", "mu.kappa",
                         "var_b0", "cov_b0b1", "var_b1", "var_inter", "cov_interintra", "var_intra"
)
CR_pour2.naive <- c((table(CR2.naive$alpha0_01)/nb.simu.cv)[2],
