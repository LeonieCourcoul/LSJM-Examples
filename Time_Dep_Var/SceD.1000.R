### Script simulations - Scenario D - 1000
...
cholesky.globale <- matrix(c(14.5,0,0,0,-1.1,2.8,0,0,0.2,-0.03,0.3,0,-0.01,0.02,-0.06,0.1), ncol = 4, byrow = T)
...
for(rep in 1:nb.simu){
  ...
  #save(lsjm.simu, file = paste("lsjm.simu_SceD.1000","_",rep,".RData",sep=""))
...
## Results
true_param <- c(1.1,-7,0.02,0.01,0.07,1.3,-4,-0.01,-0.14,0.15,142,3,2.4,0.05,14.5,-1.1,2.8,0.2,-0.03,0.3,-0.01,0.02,-0.06,0.1,
                210.25,-15.95,2.9,-0.145,9.05,-0.304,0.067,0.1309,-0.0206,0.0141)
